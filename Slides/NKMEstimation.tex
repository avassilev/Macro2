...
\framesubtitle{}
\begin{itemize}\itemsep1em
	\item Нека означим наблюденията $ {y}_1, \ldots,{y}_t $ с $ {Y}_t $, като цялата извадка е р големина $ n $
...
\begin{itemize}\itemsep1em
	...
	\end{equation}
	\item Априорната плътност $ p(\psi) $ отчита информация за параметрите, която не е включена в наблюденията (,,какво знаем, преди да сме взели данните'') -- теоретични съображения, еспертни оценки, субективни преценки, резултати от предходни изследвания
